...
const MainAdminApiEndPoints = {
    ...
    "inactiveblock": (bid) => `${BASE_URL}/mainadmin/inactiveblock/${bid}`,
    "activeblock": (bid) => `${BASE_URL}/mainadmin/activeblock/${bid}`,
    ...
    "searchMember" : (name) => `${BASE_URL}/mainadmin/searchmember/${name}`
